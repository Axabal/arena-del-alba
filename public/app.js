...
let settings={sound:true,invert:false,low:false};try{settings={...settings,...JSON.parse(localStorage.getItem('alba-settings')||'{}')};$('nickname').value=localStorage.getItem('alba-name')||'Aventurero';}catch{}
