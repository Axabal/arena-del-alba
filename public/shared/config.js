export const HEROES = {
  ...
  ogre: {id:'ogre',name:'Ogro',hp:65,damage:6,charge:24,speed:2.5,cooldown:1,range:1.5,color:'#86d874',description:'Golpes contundentes y mucha vida.',ultimate:'Tierra tóxica · 5 pulsos de 2, radio 1,8'},
